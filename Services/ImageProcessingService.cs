...
public class ImageProcessingService
{
    ...
    public async Task<IActionResult> ProcessAndSaveImageAsync(IFormFile file)
    {
        try
        {
            ...
            Каждый объект — это одна строка таблицы. 
            ВАЖНО: В качестве ключей используй названия 'Col1', 'Col2', 'Col3' и т.д. (не используй числа из ячеек как ключи!). 
            Значения — данные из ячеек. 
            Пример правильного формата: [{""Col1"": ""1855"", ""Col2"": ""2545"", ""Col3"": ""220""}, ...]. 
